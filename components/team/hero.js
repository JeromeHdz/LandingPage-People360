...
function Hero() {
  return (
    <div className="container grid gap-6 mx-auto text-white text-left lg:grid-cols-6 justify-center">
      ...
      <div className="w-full lg:col-span-3 lg:pl-6 py-16 rounded-md sm:px-12 md:px-16 dark:bg-gray-900">
        <Image
          src={heroImg}
          width={480}
          height={360}
          alt=""
          className="object-cover w-full h-full mx-auto shadow-2xl rounded-2xl overflow-hidden"
        />
      </div>
    </div>
