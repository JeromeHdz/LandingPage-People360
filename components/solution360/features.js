    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-2">
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Audi Global</h6>
          <p className="mb-3 text-sm text-gray-900">plan action</p>
          <p className="mb-3 text-sm text-gray-900">plan action</p>
          <p className="mb-3 text-sm text-gray-900">plan action</p>
        </div>
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Micro Audit</h6>
